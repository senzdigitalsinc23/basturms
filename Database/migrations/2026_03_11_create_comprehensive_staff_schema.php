...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $this->db->exec("
            CREATE TABLE IF NOT EXISTS staff_personal_info (
        ...
        // 4. Staff Employment Information
        $this->db->exec("
            CREATE TABLE IF NOT EXISTS staff_employment_info (
                id VARCHAR(36) PRIMARY KEY,
                staff_id VARCHAR(36) NOT NULL UNIQUE,
        ...
        // 5. Departments (separate from units for better organization)
        $this->db->exec("
        ...
        // Add department_id foreign key to staff_employment_info
        $this->db->exec("
            ALTER TABLE staff_employment_info 
            ADD CONSTRAINT fk_department 
            FOREIGN KEY (department_id) REFERENCES departments(id) ON DELETE SET NULL
        ");

        // 6. Staff Educational Qualifications
        $this->db->exec("
        ...
        // 7. Staff Professional Certifications
        $this->db->exec("
        ...
        // 8. Staff Work Experience (Previous Employment)
        $this->db->exec("
        ...
        // 9. Staff Bank Information
        $this->db->exec("
            CREATE TABLE IF NOT EXISTS staff_bank_info (
                id VARCHAR(36) PRIMARY KEY,
                staff_id VARCHAR(36) NOT NULL,
    ...
    public function down(): void
    {
        ...
        $this->db->exec("ALTER TABLE staff_employment_info DROP FOREIGN KEY fk_department");
