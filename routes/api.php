...
// v1 Students
$router->getApi('v1', '/students', [StudentController::class, 'index'], [APIKeyMiddleware::class]);
$router->postApi('v1', '/students/show', [StudentController::class, 'show'], [APIKeyMiddleware::class]);
