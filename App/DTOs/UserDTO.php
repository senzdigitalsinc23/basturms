...
class UserDTO
{
    public function __construct(
        ...
        public readonly ?int $failed_login_attempts,
        public readonly ?string $lockout_time,
        public readonly ?string $last_login_attempt,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            failed_login_attempts: $data['failed_login_attempts'] ?? null,
            lockout_time: $data['lockout_time'] ?? null,
